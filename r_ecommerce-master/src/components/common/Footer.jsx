      ...
      <Fragment>
        <div className="footerback  m-0 mt-4 pt-2 shadow-sm">
          <Container>
            <Row>
              ...
              <Col className="p-2" lg={3} md={3} sm={6}>
                ...
                <p className="address">Cité Orbata Elguettar Gafsa, Tunisie </p>
                <span className="address">
                  {" "}
                  <i className="fa fa-envelope"></i> wajdijbr@gmail.com{" "}
                </span>
              </Col>
            </Row>
          ...
          <Container fluid={true} className="text-center m-0 pt-3 pb-1 bg-dark">
            <Container>
              <Row>
                <h6 className="address">All Rights is reserved 2022 </h6>
              </Row>
            </Container>
          </Container>
        </div>
