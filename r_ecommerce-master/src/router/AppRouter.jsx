      ...
      <Fragment>
        ...
        <Switch>
          <Route
            exact
            path="/addproduct"
            render={(props) => <AddProduct {...props} key={Date.now()} />}
          />
          <Route
            exact
            path="/allproducts"
            render={(props) => <AllProducts {...props} key={Date.now()} />}
          />
          ...
          <Route
            exact
            path="/cardlist"
            render={(props) => <CartListPage {...props} key={Date.now()} />}
          />

          <Route
            exact
            path="/favorate"
            render={(props) => <FavoratePage {...props} key={Date.now()} />}
          />
          <Route
            exact
            path="/notification"
          ...
          <Route
            exact
            path="/subcategory"
            render={(props) => <SubCategoryPage {...props} key={Date.now()} />}
          />
